...
public class day11_Task1_Circle_Drag_N_Drop {
    ...
    public void drag_and_drop_test(){
        ...
        WebElement acceptCooliesBtn = Driver.getDriver().findElement(By.id("onetrust-accept-btn-handler"));
        acceptCooliesBtn.click();
        ...
        Assert.assertEquals(actualBigCircleText, expectedBigCircle);
    }
